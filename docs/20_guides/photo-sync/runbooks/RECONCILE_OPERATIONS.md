# Delete Reconcile — 維運 Runbook

**最後更新**: 2026-06-17  
**歸檔規格**: [60_completed/phase3-6-delete-reconcile/10_REQUIREMENTS.md](../../60_completed/phase3-6-delete-reconcile/10_REQUIREMENTS.md)  
**SSOT 進度**: [00_planning/PROGRESS_TRACKING §3.6](../../00_planning/PROGRESS_TRACKING.md)
...
- [tier-policy — 永久清除 Recently Deleted](../../00_planning/photo-sync/tier-policy/README.md)
- [scripts/photo-sync/README.md](../../../scripts/photo-sync/README.md)
- [60_completed/phase3-6-delete-reconcile/](../../60_completed/phase3-6-delete-reconcile/)
