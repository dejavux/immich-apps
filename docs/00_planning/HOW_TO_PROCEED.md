...
**v2.7.5 升級紀錄** → [IMMICH_v2.7.5.md](./infra/upgrades/IMMICH_v2.7.5.md)
...
- [photo-sync/runbooks/STORAGE_AUDIT.md](./photo-sync/runbooks/STORAGE_AUDIT.md)
- [photo-sync/10_REQUIREMENTS.md](./photo-sync/10_REQUIREMENTS.md)
