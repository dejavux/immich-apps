...
**Phase 3.6**: ✅ M1–M3（PR #19/#20 · 501 orphan trashed）· 🟡 M3.1 待 PR → [delete-reconcile/](./delete-reconcile/)
...
| [delete-reconcile/10_REQUIREMENTS.md](./delete-reconcile/10_REQUIREMENTS.md) | Phase 3.6：conservative orphan cleanup |
| [delete-reconcile/20_OPERATIONS.md](./delete-reconcile/20_OPERATIONS.md) | purge 流程 · reconcile 實測 · 檔名誤判 |
