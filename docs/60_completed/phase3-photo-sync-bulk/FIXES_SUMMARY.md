...
- 進度追蹤 (SSOT): https://github.com/dejavux/immich-apps/blob/main/docs/00_planning/PROGRESS_TRACKING.md
```
...
- **進度追蹤**: <https://github.com/dejavux/immich-apps/blob/main/docs/00_planning/PROGRESS_TRACKING.md>
