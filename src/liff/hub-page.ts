...
<body>
  ...
  <div id="hub-panel" class="${passkeyEnabled ? "hidden" : ""}">
    ...
    <a class="btn secondary" href="/liff/hub/settings">${passkeyEnabled ? "帳戶與 Passkey" : "帳戶設定"}</a>
  ...
  <script>
    ...
    async function bootstrap() {
      ...
      if (me.requiresUnlock && passkeyEnabled) {
