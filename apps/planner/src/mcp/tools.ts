...
export const MCP_TOOL_ROUTES = {
  ...
  wizard_refine: { method: "POST", path: "/wizard/sessions/:id/refine" },
...
export function listMcpTools(): Array<{
  ...
  return [
    {
      name: "wizard_start",
      description: "建立 wizard session 並回傳第一步 prompt",
    },
    ...
    {
      name: "wizard_refine",
      description: "搜尋後只改單一欄位並重新搜尋（保留其他條件）",
    },
    { name: "extract_tour", description: "從旅行社 URL 深抽完整 TourSummary" },
    {
      name: "compare_tours",
      description: "2–N 筆行程對照（shortlist id 或 inline summaries）",
    },
    {
      name: "shortlist_add",
      description: "加入家庭候選行程（url 或 summary）",
    },
